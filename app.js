...
function switchPage(tab){
  ...
  $("pageHeader").hidden=["dashboard","rebalance","history","settings"].includes(selected);
  closeMenu();
...
switchPage("dashboard");if("serviceWorker"in navigator)navigator.serviceWorker.register("./sw.js?v=12.3.2").catch(()=>{});
...
function exportBackup(){
  ...
  try{
    ...
    a.href=url;a.download=`AlphaPilot-V12.3.2-backup-${stamp}.json`;
...
// AlphaPilot V12.3.2 — auto-upgrade manual Beta when historical data becomes sufficient
(() => {
