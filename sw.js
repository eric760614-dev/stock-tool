const CACHE='alphapilot-v12-2-0-pwa';
const APP_SHELL=['./','./index.html','./style.css?v=12.2.0','./app.js?v=12.2.0','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./apple-touch-icon.png','./offline.html','./alphapilot-brand.png','./alphapilot-total-assets.png','./alphapilot-history.png','./alphapilot-rebalance.png','./alphapilot-beta.png','./alphapilot-backup.png','./alphapilot-settings.png'];
