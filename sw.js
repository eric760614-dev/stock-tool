const CACHE='alphapilot-v12-1-4-pwa';
const APP_SHELL=['./','./index.html','./style.css?v=12.1.4','./app.js?v=12.1.4','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./icon-maskable-512.png','./apple-touch-icon.png','./offline.html'];
